    ...
    return DefaultTabController(
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: <Widget>[
                IconButton(
                  ...
                  onPressed: () => debugPrint('Actions iconButton is pressed.'),
                )
              ],
              title: Text('NINGHAO'),
              //设置appBar的阴影大小
              ...
              bottom: TabBar(
                ...
                indicatorSize:
                    TabBarIndicatorSize.label, //默认值TabBarIndicatorSize.tab
                indicatorWeight: 1.0,
                tabs: <Widget>[
                  Tab(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          ...
                          colorFilter: ColorFilter.mode(
                              Colors.yellow, BlendMode.hardLight),
                          image: NetworkImage(
            ...
            endDrawer: Container(
              ...
              child: Text('This is left drawer'),
            ), //右边drawer
